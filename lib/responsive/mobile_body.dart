    ...
    return Scaffold(
        ...
        drawer: Theme(
          data: Theme.of(context).copyWith(
            canvasColor: Color.fromRGBO(10, 25, 47,
                11), //This will change the drawer background to blue.
            //other styles
          ),
          child: Drawer(
            child: Center(
              child: ListView(
                ...
                children: [
                  ListTile(
                    contentPadding: EdgeInsets.only(top: 150, left: 20),
                    leading: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          onPrimary: Color.fromRGBO(
                              90, 245, 208, 10), //background color of button
                          side: BorderSide(
                              width: 3,
                              color: Color.fromRGBO(
                                  90, 245, 208, 10)), //border width and color
                  ...
                  ListTile(
                    ...
                    leading: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromRGBO(10, 25, 47, 11),
                          onPrimary: Color.fromRGBO(
                              220, 132, 38, 0.965), //background color of button
                          side: BorderSide(
                              width: 3,
                      ...
                      Column(children: [
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            margin: EdgeInsets.all(20),
                                            child: Text(
                                              "Developed a resume app where i showcase my education,project works,skills and achivements.Used the bascis concepts of flutter and dart to implement things like navbar,ulr launcher,and responsive design across all moblie platforms ",
                                              maxLines: 10,
                                              overflow: TextOverflow.ellipsis,
                                              style: TextStyle(
                                                  color: Colors.white,
                        ...
                        Container(
                            ...
                            child: Text(
                              "Get In Touch",
                              style: TextStyle(
                                  color: Color.fromRGBO(241, 243, 243, 0.965),
                                  fontSize: 50),
                            )),
                        Container(
